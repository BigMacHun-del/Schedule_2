...
public class UpdateCommentResponse {
    ...
    public UpdateCommentResponse(Long commentId, Long scheduleId, Long userId, String userName, String content, LocalDateTime commentCreateAt, LocalDateTime commentUpdateAt) {
